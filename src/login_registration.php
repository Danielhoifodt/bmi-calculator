...
if($_SERVER["REQUEST_METHOD"] == "POST"){
    ...
    if(empty(trim($_POST["username"]))){
        ...
        $sql = "SELECT id FROM login_table WHERE username = :username";
...
<body>
    <div class="wrapper">
        <h2>Registrer deg</h2>
        <p>Vennligst fyll inn for å opprette konto.</p>
        <form action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="post">
            ...
            <div class="form-group">
                ...
                <input type="reset" class="btn btn-default" value="Nullstill">
            </div>
